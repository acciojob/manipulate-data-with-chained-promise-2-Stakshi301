    ...
    .then((numbers) => {
      ...
      return new Promise((resolve) => {
        setTimeout(() => {
          ...
          outputElement.textContent = `Even Numbers: ${evenNumbers.join(", ")}`; // Display even numbers
    ...
    .then((evenNumbers) => {
      ...
      return new Promise((resolve) => {
        setTimeout(() => {
          ...
          outputElement.textContent = `Multiplied Even Numbers: ${multipliedNumbers.join(", ")}`; // Display the result
